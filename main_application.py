...
def register_result():
    ...
    if duplicate is None:
        db.execute(text("""INSERT INTO users (user_id, password, user_name)
                            VALUES(:new_id, :new_password, :new_username)"""),
                   {"new_id": new_id, "new_password": new_password, "new_username": new_username})
        db.commit()
